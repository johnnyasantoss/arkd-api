...
function download_proto_file {
    curl -L https://raw.githubusercontent.com/ark-network/ark/${TAG}/$1 | sed 's/ark\/v1\///g' > protos/`basename $1 .proto`.proto
}
...
download_proto_file api-spec/protobuf/ark/v1/types.proto
